<img width="200" height="200" alt="image" src="https://github.com/user-attachments/assets/3fe5bb14-484b-47a2-a3cc-112ca9d52981" />

# Kaggle-Data-Science-Project
# Diabetes Risk Classification Using Health Indicators
This project uses machine learning on the CDC Health Indicators dataset to predict diabetes risk factors. It builds a classification pipeline to analyze health data and estimate an individual’s diabetes risk. Dataset: https://archive.ics.uci.edu/dataset/891/cdc+diabetes+health+indicators
## Overview
...
- Some variables were categorical like 0 for no high BP and 1 for high BP and some were numerical like BMI(12-98)
