...
This project uses machine learning on the CDC Health Indicators dataset to predict diabetes risk factors. It builds a classification pipeline to analyze health data and estimate an individual’s diabetes risk. 
